...
public class ProbabilitiesController : MonoBehaviour
{
    ...
    static List<float> cumulativeByRarity;
    ...
    //this function creates the cumulative list
    static void MakeCumulativeByProbabilityRarity(List<float> probabilityRarity)
    {
        float probabilitiesSum = 0;
    ...
    static float GetprobabilityByRarityModifer(List<float> probabilityRarity) // 5 , 20 , 2
    {
